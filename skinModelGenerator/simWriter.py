...
X_PIXELS = 400
Y_PIXELS = 400
X_VOXELS_DENSITY = 626
Y_VOXELS_DENSITY = 626
Z_VOXELS_DENSITY = 3130
        ...
        for d in dermatoscope:
            for r in room:
                ...
                values = [imageName, 
                          ...
                          str(X_PIXELS), 
                          str(Y_PIXELS), 
                          str(X_VOXELS_DENSITY), 
                          str(Y_VOXELS_DENSITY), 
                          str(Z_VOXELS_DENSITY), 
