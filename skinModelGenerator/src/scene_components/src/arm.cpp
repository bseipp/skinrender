...
std::string generateArmScene(Properties simulation){
    ...
    //create the medium
    armScene += "MakeNamedMedium \"smoke\" \"string type\" \"skin_heterogeneous\" \"integer trans_x\" " + std::to_string(simulation.density.x) + " \"integer trans_y\" " + std::to_string(simulation.density.y) + " \"integer trans_z\" " + std::to_string(simulation.density.z) + "\n";
    armScene += "\t\"point p0\" [ -" + std::to_string(simulation.arm.z / 2) + " -" + std::to_string(simulation.arm.x) + " -" + std::to_string(simulation.arm.y) + " ] \"point p1\" [ " + std::to_string(simulation.arm.z / 2) + " " + std::to_string(simulation.arm.x) + " " + std::to_string(simulation.arm.y) + " ]\n";
    ...
    if (CYLINDER_ARM_SHAPE){
      armScene += "\tShape \"cylinder\" \"float radius\" " + std::to_string(simulation.arm.x) + " \n";
      armScene += "\t\t\"float zmin\" -" + std::to_string(simulation.arm.z / 2) + "\n";
      armScene += "\t\t\"float zmax\" " + std::to_string(simulation.arm.z / 2) + "\n";
      ...
      armScene += "\t\t\"point P\" [ -" + std::to_string(simulation.arm.z / 2) + " -" + std::to_string(simulation.arm.x / 2) + "  " + std::to_string(simulation.arm.y / 2) + "  ";
      armScene += "  " + std::to_string(simulation.arm.z / 2) + "  " + std::to_string(simulation.arm.x / 2) + "  " + std::to_string(simulation.arm.y / 2) + "  ";
      armScene += "  " + std::to_string(simulation.arm.z / 2) + " -" + std::to_string(simulation.arm.x / 2) + "  " + std::to_string(simulation.arm.y / 2) + "  ";
      armScene += " -" + std::to_string(simulation.arm.z / 2) + "  " + std::to_string(simulation.arm.x / 2) + "  " + std::to_string(simulation.arm.y / 2) + "  ";
      armScene += "  " + std::to_string(simulation.arm.z / 2) + "  " + std::to_string(simulation.arm.x / 2) + " -" + std::to_string(simulation.arm.y / 2) + "  ";
      armScene += " -" + std::to_string(simulation.arm.z / 2) + "  " + std::to_string(simulation.arm.x / 2) + " -" + std::to_string(simulation.arm.y / 2) + "  ";
