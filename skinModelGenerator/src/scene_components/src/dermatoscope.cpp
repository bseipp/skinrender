...
std::string generateDermatascope(Properties simulation){
    ...
    dermatascopeView += "\t\tTranslate 0 0 " + std::to_string(simulation.arm.y + 7.3) + "\n";
    ...
    dermatascopeView += "\tTranslate 0 0 " + std::to_string(simulation.arm.y + .1 + simulation.view.z * UNIT_LENGTHS_PER_CENTIMETER) + "\n";
    ...
    dermatascopeView += "AttributeBegin\n";
    dermatascopeView += "\tTranslate 0 0 " + std::to_string(simulation.arm.y + 19.8) + "\n";
